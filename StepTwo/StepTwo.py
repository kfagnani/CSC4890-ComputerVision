...
import StepTwoCalibrating
rvecs = StepTwoCalibrating.rvecs
tvecs = StepTwoCalibrating.tvecs
...
# calucation of cos and sin of angle from rotation vector, since it gives radians we are converting them to degrees
...
intrinsic_matx = np.append( np.append(StepTwoCalibrating.mtx, [[0],[0],[1]], axis=1), [np.array([0,0,0,1])], axis=0)

print(StepTwoCalibrating.mtx)
